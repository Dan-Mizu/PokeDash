...
const encounteredWildPokemonData = ref(props.encounterLogData.slice(0, 2));
useInfiniteScroll(
...
const encounteredShinyWildPokemonData = ref(props.shinyLogData.slice(0, 2));
useInfiniteScroll(
